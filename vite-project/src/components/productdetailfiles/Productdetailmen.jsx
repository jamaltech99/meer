...
import { men } from '../Menfiles/MenData';
import Counter from '../Counterfiles/Counter';


function ProductDetailmen() {

  const [cardData,setCardData]=useState({})
  const params=useParams();
useEffect(()=>{
  const data=men.filter((item)=>item.id==params.id) 
  setCardData(data[0])
},[])
  ...
  return (
    // container
    <div className="container d-flex justify-content-center" style={{paddingTop:'50px',backgroundColor:'#f8f8f8',minWidth:'100%',paddingBottom:'50px'}}>
